...
<title>Paddy Registration Forms</title>
<!-- for-mobile-apps -->
...
<form action="insert_query_paddyreg.jsp" id="testform" method="post" novalidate>	
    <div class="main">
		<h1>Paddy Registrtion</h1>
		<div class="agileinfo_main">
				...
				<fieldset style="border: 1px solid #999">
					...
					<input id="village" name="village" type="text" required data-error-msg="We need to know which village" />
					 ...
					 <p for="pincode2">Area Of Paddy Field:</p>
					<input id="area" name="area" type="text" required data-error-msg="Please enter your Name Of Bank" />
