...
String sql ="select * from pmkisan_reg where status='Verified'";
...
<td><a href="appr_pmk.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete">Approve</button></a></td>
