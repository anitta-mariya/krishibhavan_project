...
String sql ="select * from paddy_reg where status='Verified'";
...
<td><a href="appr_paddyreg.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete">Approve</button></a></td>
