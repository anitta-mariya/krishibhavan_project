...
String sql ="select * from crop_reg where id="+id;
...
<body>
    <a href="view_farmer.html"><img src="img/bg-img/back.jpg" width="50" height="50" style="left-margin:10px"></a>
   
<form action="verify_crop_qry.jsp" id="testform" method="post" novalidate>	
    <div class="main">
