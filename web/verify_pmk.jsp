...
String sql ="select * from pmkisan_reg where id="+id;
...
<body>
     <a href="view_pmk.jsp"><img src="img/bg-img/back.jpg" width="50" height="50" style="left-margin:10px"></a>
   
<form action="verify_pmk_qry.jsp" id="testform" method="post" novalidate>	
    <div class="main">
		<h1>PM Kisan Registration Verification</h1>
