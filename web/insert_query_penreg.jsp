...
int i = st.executeUpdate("insert into pensionreg(name,address,dob,gender,phonenum,email,thaluk,block,panchayath,village,bank,accountnum,accountcopy,aadharnum,aadharcopy,rationnum,rationcopy) values('"+name+"','"+address+"','"+dob+"','"+gender+"','"+phonenum+"','"+email+"','"+thaluk+"','"+block+"','"+panchayath+"','"+village+"','"+bank+"','"+accountnum+"','"+accountcopy+"','"+aadharnum+"','"+aadharcopy+"','"+rationnum+"','"+rationcopy+"')");
 if (i>0) {
        //session.setAttribute("userid", user);
        response.sendRedirect("pension_reg.jsp");
