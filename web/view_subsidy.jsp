...
<form class="form-inline" method="post" action="serqry_subsidy.jsp">
...
">
			...
			<form method="post" id="user_form">
				<h1 class="text-warning text-center"><font color="white">Subsidy Registration View</font></h1>
...
String sql ="select * from subsidy_apply";
...
<td><a href="verify_subsidy.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete">Verify</button></a></td>
<td><a href="dele_subsidy.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete">Reject</button></a></td>
