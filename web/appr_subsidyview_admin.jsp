...
String sql ="select * from subsidy_apply where status='Verified'";
...
<td><a href="appr_subsidy.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete">Approve</button></a></td>
