...
<body>
    <a href="view_pension.jsp"><img src="img/bg-img/back.jpg" width="50" height="50" style="left-margin:10px"></a>
   
<form action="verify_pension_qry.jsp" id="testform" method="post" novalidate>	
    <div class="main">
		<h1>Pension Registration Verification</h1>
