          ...
          <div class="col-12">
            <div class="top-header-content d-flex align-items-center justify-content-between">
              ...
              <div class="top-header-meta">
                <p>Welcome to <span>Krishibhavan Thekkumkura</span>, we hope you will enjoy our services and have good experience</p>
              </div>
              <!-- Top Header Content -->
...
">
			...
			<form method="post" id="user_form">
				<h1 class="text-warning text-center"><font color="white">Farmer Registration View</font></h1>
...
String sql ="select * from fregform";
...
<td><%=resultSet.getString("verify") %></td>
...
<td><a href="verify_farmreg.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete">Verify</button></a></td>

<td><a href="dele_farmreg.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete">Reject</button></a></td>
