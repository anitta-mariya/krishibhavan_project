...
String sql ="select * from debt_relief";
...
<td><a href="verify_debt.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete">Verify</button></a></td>
<td><a href="dele_debt.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete">Delete</button></a></td>
