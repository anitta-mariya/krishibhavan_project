...
">
			...
			<form method="post" id="user_form">
				<h1 class="text-warning text-center"><font color="white">Debt-Relief Registration View</font></h1>
...
String sql ="select * from debt_relief where status='Verified'";
...
<td><a href="appr_debt.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete">Approve</button></a></td>
