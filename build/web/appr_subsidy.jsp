...
String sql ="select * from subsidy_apply where id="+id;
...
<body>
	<a href="appr_subsidyview_admin.jsp"><img src="img/bg-img/back.jpg" width="50" height="50" style="left-margin:10px"></a>	
	    ...
	    <div class="w3ls-agileinfo">
		 ...
		 <div class="bg-agile">
			...
			<div class="login-form">	
				<form action="appr_viewsub_qry.jsp" method="post">
