...
<form action="insert_query_subsidy.jsp" id="testform" method="post" novalidate>	
    <div class="main">
		<h1>Apply Subsidy </h1>
		<div class="agileinfo_main">
				...
				<fieldset style="border: 1px solid #999">
					...
					<input id="village" name="village" type="text" required data-error-msg="We need to know which village" />
                                        <p for="village">Category</p>
					
                                        <select name="item">
                                            <option value="">hshjd</option>
                                              <option value="">dhshjd</option>
                                              
                                           
                                        </select>
                                       
                                        <p for="village">Area</p>
