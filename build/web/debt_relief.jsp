...
<html>
<head>
    <div class="single-welcome-slides bg-img bg-overlay jarallax" style="background-image: url(img/bg-img/72.jpeg);">
<title>Apply Subsidy</title>
<!-- for-mobile-apps -->
...
<form action="insert_query_relief.jsp" id="testform" method="post" novalidate>	
    <div class="main">
		<h1>Apply Debt-Relief </h1>
		<div class="agileinfo_main">
				...
				<fieldset style="border: 1px solid #999">
					...
					<input id="village" name="village" type="text" required data-error-msg="We need to know which village" />
                                        ...
                                        <p for="village">Category for relief</p>
					<input id="item" name="item" type="text" required data-error-msg="We need to know which village" />
					
                                        <p for="village">Number Of Item/area Destroyed</p>
					<input id="area" name="area" type="text" required data-error-msg="We need to know which village" />
					
                                         <p for="village">Photo Of Item/area Destroyed</p>
					<input id="itencopy" name="itemcopy" type="file" required data-error-msg="We need to know which village" />
					
					 <p for="pincode2">Name Of Bank:</p>
					<input id="bank" name="bank" type="text" required data-error-msg="Please enter your Name Of Bank" />
				...
				<fieldset style="border: 1px solid #999">
					<legend>Attachment:</legend>
                                        ...
                                        <p for="pincode2">Account No:</p>
					<input id="accountnum" name="accountnum" type="text" required data-error-msg="Please enter your account number" />
					
					<p for="pincode2">Account copy</p>
					<input id="accountcopy" name="accountcopy" type="file" required data-error-msg="Please attach your account copy" />
			  ...
			  <p for="pincode2">Aadhar card copy</p>
					...
					<p for="pincode">Ration card number</p>
					<input id="rationnum" name="rationnum" type="text" required data-error-msg="Please enter your aadhar card number" />
					
				<p for="city">Ration card copy</p>
					<input id="rationcopy" name="rationcopy" type="file" required data-error-msg="Attach enter your aadhar copy" />
