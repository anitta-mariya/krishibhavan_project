...
<div class="col-lg-12">
<br><br>
<h1 class="text-warning text-center"><font color="green">View Feedback</font></h1>
...
String sql ="select * from feedback_farmer";
...
<td><a href="delete_feedback.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete">Delete</button></a></td>
