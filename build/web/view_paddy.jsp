...
<header class="header-area">
          ...
          <div class="col-12">
            <div class="top-header-content d-flex align-items-center justify-content-between">
              ...
              <div class="top-header-meta">
                <p>Welcome to <span>Krishibhavan Thekkunkara</span>, we hope you will enjoy our services and have good experience</p>
              </div>
              <!-- Top Header Content -->
    ...
    <form class="form-inline" method="post" action="serqry_farmerreg.jsp">
      ...
      <div class="classy-nav-container breakpoint-off">
        <div class="container">
          ...
          <nav class="classy-navbar justify-content-between" id="famieNav">
            <!-- Nav Brand -->
            <p><h1>Krishibhavan Thekkunkara</h1></p>
            <!-- Navbar Toggler -->
            ...
            <div class="classy-menu">
              ...
              <div class="classynav">
                <ul>
                    <li class="active"><a href="slayout.html"><b>back</b></a></li></ul>
...
">
			...
			<form method="post" id="user_form">
				<h1 class="text-warning text-center"><font color="white">Paddy Registration View</font></h1>
...
<td><a href="verify_paddy.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete">Verify</button></a></td>

<td><a href="dele_paady.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete">Reject</button></a></td>
