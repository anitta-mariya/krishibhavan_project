...
int i = st.executeUpdate("insert into paddy_reg(name,address,dob,gender,phonenum,email,thaluk,block,panchayath,village,area,rationnum,rationcopy,aadharnum,aadharcopy) values('"+name+"','"+address+"','"+dob+"','"+gender+"','"+phonenum+"','"+email+"','"+thaluk+"','"+block+"','"+panchayath+"','"+village+"','"+area+"','"+rationnum+"','"+rationcopy+"','"+aadharnum+"','"+aadharcopy+"')");
 if (i>0) {
        //session.setAttribute("userid", user);
        response.sendRedirect("paddyreg.jsp");
