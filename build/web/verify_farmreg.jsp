...
<body>
    <a href="view_farmreg.jsp"><img src="img/bg-img/back.jpg" width="50" height="50" style="left-margin:10px"></a>
   
<form action="verify_farmreg_qry.jsp" id="testform" method="post" novalidate>	
    <div class="main">
		...
		<div class="agileinfo_main">
				...
				<fieldset style="border: 1px solid #999">
					...
					<select id="weight" name="verify" required>
