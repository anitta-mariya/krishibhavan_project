...
String sql ="select * from fregform where verify='Verified'";
...
<td><a href="appr_farreg.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete">Approve</button></a></td>
