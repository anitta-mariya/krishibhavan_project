...
String sql ="select * from crop_reg";
...
<td><a href="verify_crop.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete">Verify</button></a></td>
<td><a href="dele_crop.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete">Delete</button></a></td>
