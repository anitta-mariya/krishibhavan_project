...
String itemcopy=request.getParameter("itemcopy");
...
int i = st.executeUpdate("insert into debt_relief(name,address,dob,gender,phonenum,email,thaluk,block,panchayath,village,item,area,itemcopy,bank,accountnum,accountcopy,aadharnum,aadharcopy,rationnum,rationcopy) values('"+name+"','"+address+"','"+dob+"','"+gender+"','"+phonenum+"','"+email+"','"+thaluk+"','"+block+"','"+panchayath+"','"+village+"','"+item+"','"+area+"','"+itemcopy+"','"+bank+"','"+accountnum+"','"+accountcopy+"','"+aadharnum+"','"+aadharcopy+"','"+rationnum+"','"+rationcopy+"')");
 if (i>0) {
        //session.setAttribute("userid", user);
        response.sendRedirect("debt_relief.jsp");
