...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <!-- Main content -->
    <section class="content" style="margin-left:268px;">
...
<div class="col-lg-12">
<br><br>
<h1 class="text-warning text-center"><font color="green">Display leave</font></h1>
...
<td><a href="approve_leave.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete">Approve</button></a></td>
