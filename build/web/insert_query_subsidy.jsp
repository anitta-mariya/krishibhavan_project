...
int i = st.executeUpdate("insert into subsidy_apply(name,address,dob,gender,phonenum,email,thaluk,block,panchayath,village,item,area,bank,accountnum,accountcopy,aadharnum,aadharcopy,rationnum,rationcopy) values('"+name+"','"+address+"','"+dob+"','"+gender+"','"+phonenum+"','"+email+"','"+thaluk+"','"+block+"','"+panchayath+"','"+village+"','"+item+"','"+area+"','"+bank+"','"+accountnum+"','"+accountcopy+"','"+aadharnum+"','"+aadharcopy+"','"+rationnum+"','"+rationcopy+"')");
 if (i>0) {
        //session.setAttribute("userid", user);
        response.sendRedirect("subsidy.jsp");
