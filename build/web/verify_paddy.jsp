...
<body>
     <a href="view_paddy.jsp"><img src="img/bg-img/back.jpg" width="50" height="50" style="left-margin:10px"></a>
   
<form action="verify_paddy_qry.jsp" id="testform" method="post" novalidate>	
    <div class="main">
		<h1>Paddy Registration Verification</h1>
